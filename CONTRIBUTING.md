...
We welcome all contributions to BoostMut!

Contributions can take many forms, such as:

* sharing bug reports or feature requests through the [Issue Tracker](https://github.com/kt-korbeld/BoostMut/issues)
...
The second two options both involve making a [pull request](https://github.com/kt-korbeld/BoostMut/pulls) .
